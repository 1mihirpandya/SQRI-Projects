...
to setup
  ...
  ask citizens [set insurgents n-of 4 other turtles]
  reset-ticks
...
to go
  ...
  if attacker != nobody
       [ask attacker [set color red
        ...
        ask attacker [if any? turtles with [shape = "star"] in-radius 10
                                                  [


                                                    let new_friend one-of turtles with [shape = "star"] in-radius 10
                                                    if new_friend != nobody [
                                                    move-to new_friend
                                                    print "moved star"
                                                    find-new-spot
                                                  ]
  ...
  if accuracy < 50 [
  ask citizens [
if not any? turtles with [color = green] in-radius 1 [
if any? turtles with [color = green] in-radius 10
                                                  [
                                                    let new_friend one-of turtles with [color = green] in-radius 10
                                                    if new_friend != nobody [
                                                    move-to new_friend
                                                    print "moved citizen"
                                                    find-new-spot
...
if not any? turtles with [shape = "star"] in-radius 1 [
if any? turtles with [shape = "star"] in-radius 10
                                                 [

                                                    let enemy one-of turtles with [shape = "star"] in-radius 10
                                                    if enemy != nobody [
                                                    move-to enemy
                                                    print "moved soldier"
                                                    find-new-spot
